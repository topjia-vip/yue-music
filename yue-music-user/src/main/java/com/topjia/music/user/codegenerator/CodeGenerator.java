package com.topjia.music.user.codegenerator;
...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/music_user?allowPublicKeyRetrieval=true&useUnicode=true&useSSL=false&characterEncoding=utf8");
